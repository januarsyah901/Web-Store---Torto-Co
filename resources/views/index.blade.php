        ...
        "loop": true
            ...
            <div class="swiper-wrapper hero">
                    ...
                    <div class="overflow-hidden position-relative h-100">
                        ...
                        <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
                            <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                                New Arrivals</h6>
                            <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Refined Looks</h2>
                            <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">Timeless Style</h2>
                            <a href="#"
                ...
                <div class="swiper-slide">
                    <div class="overflow-hidden position-relative h-100">
                        <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                            <img loading="lazy" src='{{asset("assets/images/home/demo3/slideshow-character3.png") }}' width="400" height="733"
                                 alt="Woman Fashion 1"
                                 class="slideshow-character__img animate animate_fade animate_btt animate_delay-9 w-auto h-auto" />
                        ...
                        <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
                            <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                                New Arrivals</h6>
                            <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Effortlessly Sharp</h2>
                            <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">Every Day</h2>
                            <a href="#"
                               class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Shop
                                Now</a>
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="overflow-hidden position-relative h-100">
                        <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                            <img loading="lazy" src='{{asset("assets/images/home/demo3/slideshow-character2.png") }}' width="400" height="690"
                                 alt="Woman Fashion 2"
                        ...
                        <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
                            <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                                New Arrivals</h6>
                            <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Live Easy,</h2>
                            <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">Dress Right.</h2>
                            <a href="#"
                               class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Shop
                                Now</a>
                        </div>
