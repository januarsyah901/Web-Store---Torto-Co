    ...
    <div class="container d-flex align-items-center h-100">
        ...
        <div class="logo">
            <a href="{{ route('home.index') }}">
                <img src='{{ asset("assets/images/logo.png")}}' width="40" alt="torto n co" class="logo__image d-block"/>
            </a>
        </div>
            ...
            <div class="overflow-hidden">
                <ul class="navigation__list list-unstyled position-relative">
                    ...
                    <li class="navigation__item">
                        ...
                        @else
                            <a href="{{ Auth::user()->role === 'admin' ? route('admin.index') : route('user.index') }}" class="navigation__link">
                                <span class="pr-6px">{{ Auth::user()->name }}</span> | Dashboard
                            </a>
                        @endguest
                    </li>
                </ul>
...
<header id="header" class="header header-fullwidth header-transparent-bg">
    <div class="container">
        <div class="header-desk header-desk_type_1">
            <div class="logo">
                <a href="{{ route('home.index') }}">
                    <img src='{{ asset("assets/images/logo.png")}}' width="50" alt="torto n co" class="logo__image d-block"/>
                </a>
            </div>
                ...
                @guest
                    <div class="header-tools__item hover-container">
                        <a href="{{route('login')}}" class="header-tools__item">
                            <svg class="d-block mx-1" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <use href="#icon_user"/>
                            </svg>
                            Login
