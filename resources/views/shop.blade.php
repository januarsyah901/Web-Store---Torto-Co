                    ...
                    <div class="product-card-wrapper">
                        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                            <div class="pc__img-wrapper">
                                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="details.html">
                                                <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $p->image }}" width="330" height="400" alt="{{ $p->name }}" class="pc__img">
                                            </a>
                                        </div>
                                        @foreach(explode(',', $p->images) as $image)
                                            <div class="swiper-slide">
                                                <a href="details.html">
                                                    <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $image }}" width="330" height="400" alt="{{ $p->name }}" class="pc__img">
                                                </a>
                                            </div>
                                        @endforeach
                                    </div>
                            ...
                            <div class="pc__info position-relative">
                                ...
                                <h6 class="pc__title"><a href="details.html">{{ $p->name }}</a></h6>
                                <div class="product-card__price d-flex">
                                    @if($p->sale_price)
                                        <span class="money price">${{ $p->sale_price }}</span>
                                        <span class="text-secondary ms-2"><s>${{ $p->regular_price }}</s></span>
                                    @else
                                        <span class="money price">${{ $p->regular_price }}</span>
                                    @endif
                                </div>
