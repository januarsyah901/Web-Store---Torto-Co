...
<!-- Tabbed Register Form (Bootstrap) -->
<main class="pt-90">
                ...
                <div class="register-form">
                    <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation" novalidate>
                        ...
                        <div class="form-floating mb-3">
                            <input id="name" class="form-control form-control_gray @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
